...
| RNA-seq | [SRA accessions](https://www.ncbi.nlm.nih.gov/sra?LinkName=bioproject_sra_all&from_uid=1101486) , B73×W22 NAM lines, WW + DS conditions, 69 runs each (23 lines × 3 reps); replicate-averaged RPKM matrix |
